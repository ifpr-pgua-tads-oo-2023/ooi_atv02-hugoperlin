...
public class JogoJokenpo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "\tPedra:" + qtdePedraUsuario + " Papel:" + qtdePapelUsuario + " Tesoura:" + qtdeTesouraUsuario);
        System.out.println("Computador:");
        System.out.println("\tPedra:" + qtdePedraComputador + " Papel:" + qtdePapelComputador + " Tesoura:"
                + qtdeTesouraComputador);
