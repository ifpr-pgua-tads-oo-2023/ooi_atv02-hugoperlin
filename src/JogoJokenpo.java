    ...
    public static void main(String[] args) {
        ...
        while (contRodadas < nRodadas) {
            ...
            if (opcaoUsuario >= 1 && opcaoUsuario <= 3) {
                opcoesUsuario[opcaoUsuario - 1] = opcoesUsuario[opcaoUsuario - 1] + 1;
        ...
        System.out
                .println("\tPedra:" + opcoesUsuario[0] + " Papel:" + opcoesUsuario[1] + " Tesoura:" + opcoesUsuario[2]);
        System.out.println("Computador:");
        System.out.println(
                "\tPedra:" + opcoesComputador[0] + " Papel:" + opcoesComputador[1] + " Tesoura:" + opcoesComputador[2]);
